...
interface InstagramAccountFormModalProps {
  open: boolean
  onClose: () => void
  editItem?: InstagramAccount | null
}

export function InstagramAccountFormModal({ open, onClose, editItem }: InstagramAccountFormModalProps) {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title={editItem ? 'Modifier le compte Instagram' : 'Ajouter un compte Instagram'}
      size="md"
    >
