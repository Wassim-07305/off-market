...
import { X, Info, AlertTriangle, CheckCircle2, Sparkles, ChevronDown, ChevronUp } from 'lucide-react'
import { AnimatePresence, motion } from 'framer-motion'
import { useAnnouncements, useDismissAnnouncement } from '@/hooks/useAnnouncements'
import { cn } from '@/lib/utils'
import type { Announcement } from '@/types/database'

const typeConfig: Record<Announcement['type'], { icon: typeof Info; bg: string; border: string; text: string }> = {
  info: {
    icon: Info,
    bg: 'bg-blue-50',
...
function AnnouncementItem({ announcement, onDismiss }: { announcement: Announcement; onDismiss: () => void }) {
