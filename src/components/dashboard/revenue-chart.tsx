    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-2xl font-display font-bold text-foreground tracking-tight">
          {totalRevenue.toLocaleString("fr-FR")} <span className="text-sm font-mono text-muted-foreground font-normal">EUR</span>
        </span>
      </div>
      <div className="h-64">
        {isLoading ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-muted-foreground">
            ...
            <p className="text-xs mt-1 text-muted-foreground/60">Les revenus apparaitront ici quand des factures seront payees</p>
          </div>
        ) : (
